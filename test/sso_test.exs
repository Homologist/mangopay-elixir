defmodule SsoTest do
  ...
  test "update sso" do
    use_cassette "#{module_name(__MODULE__)}/sso/update" do
  ...
  test "get sso" do
    use_cassette "#{module_name(__MODULE__)}/sso/get" do
  ...
  test "all sso" do
    use_cassette "#{module_name(__MODULE__)}/sso/all" do
  ...
  test "extend invitation sso" do
    use_cassette "#{module_name(__MODULE__)}/sso/extend_invitation/update" do
  ...
  test "all by permission group sso" do
    use_cassette "#{module_name(__MODULE__)}/sso/permission_group/all" do
      assert {:ok, response} =
